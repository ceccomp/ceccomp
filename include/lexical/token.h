...
typedef enum
{
  ...
  ARCH_RISCV64, ARCH_SH4, ARCH_SHEB, ARCH_SH,
...
void init_token (token_t *token, const scanner_t *scanner, token_type type);

void init_token_data (token_t *token, const scanner_t *scanner,
                      token_type type, uint32_t data);
